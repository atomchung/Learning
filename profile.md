...
- **AI 產業判斷 / 投資訊號** — 讀信號不讀數字、開源商品化計時器、價值流向、中國開源、模型進步軌跡;最新:AI 資安生態位(CRWD 財報→賣鏟人故事誰最對位,排序 PANW>CRWD>ZS>S1,延伸「身份是 agent 的收費站」「賣鏟人故事的計價斷層」兩條可跨脈絡元判斷,`notes/ai-security-ecosystem.md`);前次:Robinhood agentic trading(`notes/robinhood-agentic-trading.md`)、Anthropic 5–6 月 blog(`notes/anthropic-blog-2026-06.md`)、eval 生態位(`notes/eval-ecosystem-niche.md`)
