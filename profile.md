...
updated: 2026-07-03
last-session: 2026-07-03 業界 best practice 掃描：架構層零新東西，機制層三缺口全命中開放線——B11 validation-gate（SkillOpt，Issue #6 設計輸入已齊可跑首次 /meta-review）、B12 機械 lint（rot）、B13 並發寫標準解（Issue #7 外部背書）；CLAUDE.md 壓行數有了機制理由（>200 行整塊被忽略）。詳見 `notes/repo-best-practices-scan-2026-07.md`、inbox 2026-07-03。前次 Block×Armstrong 合讀見 inbox 2026-06-28
