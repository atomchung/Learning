...
updated: 2026-06-27
last-session: Codex 取代 ChatGPT 論文（OpenAI agentic 遷移，arXiv 2606.26959）——關鍵自覺＝這是「判讀型輸入不是借鑒型」（給信號更新 belief，非可搬機制），用戶推一把推出來；別為「研究了」造假 actionable。張力：併單一 surface＝harness 主戰場(A) 還 orchestration 被模型化吃掉(B)＝loop-eng 開放疑問新數據點。進 `notes/codex-agentic-shift.md`
