...
updated: 2026-06-28
last-session: 2026-06-28 Block×Armstrong 合讀沉新卡「治理靠改預設而非設限（前提：預設接近 Pareto）」＝harness>model 的企業尺度版（模型商品化→瓶頸上移到身份/權限/成本路由）；同構到 repo 原則 #4 與 Issue #6 北極星「改預設>設限＝能刪規則的 RSI」。前次 Q2 情報掃描（並行 4 子 agent、擋下 prompt injection）詳見 inbox 2026-06-28（較早那筆）
