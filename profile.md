...
updated: 2026-07-04
last-session: 2026-07-04 首次 /meta-review（worktree 舊分支缺 skill、手動照 SKILL.md 跑，該坑本身記了一筆 merge-gap）：立第五類 write-conflict＋熱檔寫前 rebase 規則＋CLAUDE.md 首次反向砍行（Obsidian 設定段移 notes/）。詳見 inbox 2026-07-04
