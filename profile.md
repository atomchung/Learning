...
## 你持續關注的話題
（隨口疑問會讓對應話題往上浮；新主題自動長出來）

- **AI agents / coding agents** — 目前最深，13 張卡。harness、沙箱、記憶架構、人機協作；最新讀了 Salesforce 全公司 agentic 化案例（`notes/salesforce-agentic-engineering.md`）
- **AI 產業判斷 / 投資訊號** — 讀信號不讀表面數字、開源是商品化計時器、價值流向關係型部門
- **知識系統怎麼設計才真的複利** — 元主題，就是這個 repo 本身
...
- 這套知識系統怎麼對我產生收益？
  ...
  → 下一個可能的開放問題：要不要設 SessionStart hook 讓 boot 完全自動、不靠我讀指令？
